...
namespace Module.Services
{
    ...
    /// </summary>
    public class ImportKmzFromSmudiService : DisposeService
    {
        #region Properties
        ...
        private static ImportKmzFromSmudiService _instance;
        public static ImportKmzFromSmudiService Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new ImportKmzFromSmudiService();
                return _instance;
            }
            set
            {
        ...
        /// </summary>
        private ImportKmzFromSmudiService()
        {
            ...
            if (feature.GetType() == (typeof(Placemark)))
            {
                ...
                if (placemark.Geometry != null)
                {
                    if (placemark.Geometry.GetType() == (typeof(SI.SMUDI.Cmm.Utils.Dom.Point)))
                    {
                        ...
                        else if (styles.Normal.Label == null || styles.Normal.Label.Scale == null || styles.Normal.Label.Scale != 0)
